...
{% Image "src/images/posts/hackference-2018/mike.jpeg", "Mike Elsmore opening the conference", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/marta.jpeg", "Marta Bondyra", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/terence.jpeg", "Terence Eden", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/jess.jpeg", "Jessica Rose", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/anna_hax.jpeg", "Anna hacking", "(max-width: 600px) 600w, 900w" %}
📷 _[Anna](https://twitter.com/anna_hax) mid hack_

{% Image "src/images/posts/hackference-2018/jamie_trex.jpeg", "Jamie being attacked by a T-Rex", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/impact_hub.jpeg", "Impact Hub", "(max-width: 600px) 600w, 900w" %}
...
{% Image "src/images/posts/hackference-2018/who_dis.png", "Cat illustration with caption 'new login, who dis?'", "(max-width: 600px) 600w, 900w" %}

📷 _Home page illustration for ‘New login, who dis?’ by our in-team illustrator [Anna Dodson](https://twitter.com/anna_hax) 😋_

And… we won!

We won some really cool Auth0 Hacktoberfest t-shirts and we won an amazing Nanoleaf kit each from Nexmo!
{% Image "src/images/posts/hackference-2018/team_and_jeremy.png", "Our hack team with Jeremy Meiss, from Auth0", "(max-width: 600px) 600w, 900w" %}
📷 _Our hack team with [Jeremy Meiss](https://twitter.com/IAmJerdog) from Auth0_

{% Image "src/images/posts/hackference-2018/team_and_sam.jpg", "Our hack team with Sam Machin, from Nexmo", "(max-width: 600px) 600w, 900w" %}
