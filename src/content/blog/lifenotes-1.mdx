...
import merlotAndI from '@images/posts/lifenotes-1/merlot-and-i.jpeg';
...
<Image
    src={thomAndI}
    alt="Thom and I having a soggy stroll by Talla Reservoir"
    widths={[600, 900]}
...
<Image
    src={waterfall}
    alt="Thom and Merlot by Wolfcleuch Waterfall, in Craik Forest"
    widths={[600, 900]}
    sizes="(max-width: 600px) 600w, 900w"
/>
...
<Image
    src={merlotAndI}
    alt="Merlot and I having a cuddle"
    widths={[600, 900]}
    sizes="(max-width: 600px) 600w, 900w"
/>
