...
import behaviouralQs from "@images/posts/looking-for-a-job/behavioural-qs.png";
...
<Image
  src={notionPage}
  alt="Screenshot of my notion job search page: content is described below."
  widths={[600, 900]}
...
This is a very short paragraph about me that I can copy and paste into emails, application forms or wherever it’s useful.
...
<Image
  src={behaviouralQs}
  alt="Screenshot of a table on notion, content is described below."
  widths={[600, 900]}
  sizes="(max-width: 600px) 600w, 900w"
/>
...
If it’s helpful at all to you, you can [take a peek at my salary history](https://carol.gg/salary/).
